...
bitflags!{
    ...
    pub flags PostProcessSteps: c_uint {
        ...
        ///
        const SORT_BY_PRIM_TYPE = 0x8000,
        ...
        ///
        ///
        /// 2. (if you don't support lines and points at all)<br>
        ///
        ///   * Specify the #aiProcess_FindDegenerates flag.
        ...
        ///
        const FIND_DEGENERATES = 0x10_000,
        ...
        ///
        const FIND_INVALID_DATA = 0x20_000,
        ...
        ///
        const TRANSFORM_UV_COORDS = 0x80_000,
        ...
        ///
        const OPTIMIZE_MESHES = 0x200_000,
        ...
        ///
        const OPTIMIZE_GRAPH = 0x400_000,
        ...
        /// @deprecated
        ///
        const CONVERT_TO_LEFT_HANDED =
            MAKE_LEFT_HANDED.bits | FLIP_UVS.bits | FLIP_WINDING_ORDER.bits,
        ...
        /// he #aiProcess_ConvertToLeftHanded step. If you don't support UV transformations
        /// n your application apply the #aiProcess_TransformUVCoords step, too.
        /// @note Please take the time to read the docs for the steps enabled by this preset.
        /// Some of them offer further configurable properties, while some of them might not be
        /// of
        /// use for you so it might be better to not specify them.
        ///
        const TARGET_REALTIME_FAST =
            CALC_TANGENT_SPACE.bits | GEN_NORMALS.bits | JOIN_IDENTICAL_VERTICES.bits
            | TRIANGULATE.bits | GEN_UV_COORDS.bits | SORT_BY_PRIM_TYPE.bits,
        ...
        ///
        const TARGET_REALTIME_QUALITY =
            CALC_TANGENT_SPACE.bits | GEN_SMOOTH_NORMALS.bits | JOIN_IDENTICAL_VERTICES.bits
            | IMPROVE_CACHE_LOCALITY.bits | LIMIT_BONE_WEIGHTS.bits
            | REMOVE_REDUNDANT_MATERIALS.bits | SPLIT_LARGE_MESHES.bits | TRIANGULATE.bits
            | GEN_UV_COORDS.bits | SORT_BY_PRIM_TYPE.bits | FIND_DEGENERATES.bits
            | FIND_INVALID_DATA.bits,
